...
function CartridgeDescription() {
    ...
    return (
        <div className='p-2 pt-0 text-xs overflow-auto custom-scrollbar max-h-96'>
            {('owned_copies' in selectedCartridge && selectedCartridge.owned_copies > 0) &&
            ...
            <div className="grid grid-cols-2">
                ...
                <div>
                    ...
                    <pre className={fontPressStart2P.className}>
                        ...
                        <button disabled={!wallet || !('owned_copies' in selectedCartridge && selectedCartridge.owned_copies > 0) || selectedCartridge.sell_price <= 0} className="btn w-1/3 ml-1" onClick={sell}>
                            SELL
                        </button>
                    </pre>
                </div>
